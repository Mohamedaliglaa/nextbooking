    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden lg:rounded-none lg:overflow-visible">
              ...
              <div className="relative p-6 sm:p-8 lg:p-0">
                ...
                <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mt-4 leading-relaxed">
                  ...
                  Votre course est à un clic avec une disponibilité 24h/24 et
                  7j/7.
                </p>
                ...
                <div className="mt-6">
                  <button
                    ...
                    className="inline-flex items-center justify-center px-5 py-3 rounded-full bg-primary text-primary-foreground text-sm sm:text-base font-semibold shadow-md hover:bg-primary/90 transition-colors"
                  >
                    Réserver une course
                  </button>
                </div>
          ...
          {/* FORM (right column) */}
          <div className="relative z-30" id="booking-form">
            <div className="p-1">
              <BookingForm />
            </div>
          </div>
